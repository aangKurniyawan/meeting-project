       ...
       <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#memberList" data-toggle="tab">Member List</a></li>
              <li><a href="#registered" data-toggle="tab">Member Registered</a></li>
              ...
              <div class="col-md-6">
                <?php 
                    if ($this->session->flashdata('gagalAddAbsen')){
                      ...
                      echo "</div>";
                    }else if($this->session->flashdata('duplicatResult')){
                      echo "<div class='alert alert-danger alert-dismissible'>";
                      echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
                      echo "<h4><i class='icon fa fa-ban'></i> Alert!</h4>";
                      echo $this->session->flashdata('duplicatResult');
                      echo "</div>";
                    }
                 ?>
                 <?php 
                        ...
                        <tbody>
                          ...
                          ?>
                           <tr>
                              ...
                              <td>
                                <!-- action="<?php echo base_url('konfirmasi_hadir');?>" method="post" -->
                                <form action="<?php echo base_url('konfirmasi_hadir_notulen');?>" method="post">
                                  ...
                                  <button type="submit"  <?php $status=$data['status']; if($status !='Aktif'){ echo"class='btn btn-primary hidden'"; }else{echo"class='btn btn-primary'";}?>>
                                    Present
                                  </button>
                                </form>
                              </td>
              ...
              <div class="tab-pane" id="meetingResult">
                 <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label>Tittle</label>
                      <input type="text" class="form-control pull-right" placeholder="Tittle of meeting">
                    </div>
                    <br><br>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Budget Set">
                    </div>
                    <!-- /.form-group -->
                    <div class="form-group">
                      <label>Budget Used</label>
                      <input type="text" class="form-control" placeholder="Budget Used">
                    </div>
                  </div>
                  <div class="col-md-12">
