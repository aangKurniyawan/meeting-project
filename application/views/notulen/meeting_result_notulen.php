...
<?php $this->load->view('notulen/header_notulen');?>
       ...
       <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#meetingResult" data-toggle="tab">Meeting Result</a></li>
              <!-- <li><a href="#memberList" data-toggle="tab">Member List</a></li>
              <li><a href="#memberPresence" data-toggle="tab">Member Presence</a></li>
              <li><a href="#meetingResult" data-toggle="tab">Meeting Result</a></li> -->
            </ul>
            <div class="tab-content">
              <div class="col-md-6">
                <?php 
                    if ($this->session->flashdata('gagalResult')){
                      echo "<div class='alert alert-danger alert-dismissible'>";
                      echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
                      echo "<h4><i class='icon fa fa-ban'></i> Alert!</h4>";
                      echo $this->session->flashdata('gagalResult');
                      echo "</div>";
                    }else if($this->session->flashdata('berhasilResult')){
                      echo "<div class='alert alert-success alert-dismissible'>";
                      echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
                      echo "<h4><i class='icon fa fa-ban'></i> Alert!</h4>";
                      echo $this->session->flashdata('berhasilResult');
                      echo "</div>";
                    }
                 ?>
               </div>
                        ...
                        <tbody>
                          ...
                          ?>
                           <tr>
                              ...
                              <td><?php echo $row['email'];?></td>
                              <td>
                                <form action="<?php echo base_url('konfirmasi_hadir');?>" method="post">
                                  <input type="hidden" id="id_schdule" name="id_schedule" value="<?php echo $data['id_schedule'];?>">
                                  <input type="hidden" id="id_user" name="id_user" value="<?php echo $row['id_user'];?>">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <tbody>
                          <?php
                            $no = 1;
                            foreach($memberAtendance as $row){ 
                          ?>
                           <tr>
                              <td><?php echo $no++?></td>
                              <td><?php echo $row['nama_user'];?></td>
              ...
              <div class="active tab-pane" id="meetingResult">
                <div class="row">
                  <div class="col-md-12">
                    <form action="<?php  echo base_url('add_result_notulen');?>" method="post">
                    <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group date">
                        ...
                        <input type="text" name="tanggal" value="<?php echo $data['tanggal'];?>" readonly required class="form-control pull-right" id="datepicker">
                      </div>
                    </div>
                    <div class="form-group">
                      <label>Tittle</label>
                      <input type="text" value="<?php echo $data['tittle_meeting'];?>" class="form-control pull-right" readonly>
                    </div>
                    <br><br>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="number" name="budget_set" class="form-control" required placeholder="Budget Set">
                    </div>
                    <div class="form-group">
                      <label>Budget Used</label>
                      <input type="number" name="budget_used" class="form-control" required placeholder="Budget Used">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <textarea id="editor1" name="meeting_notes" rows="10" cols="80" required>
                        
                    </textarea><br>
                  </div>
                  <div class="col-md-10">
                    <div class="input-group date">
                      <button type="submit" class="btn btn-block btn-primary">Submit Meeting Result</button>
                    </div>
                  </div>
                </form>
                </div>
