            ...
            <div class="tab-content">
              <div class="col-md-6">
                <?php 
                 ...
                 ?>
                 <?php 
                    if ($this->session->flashdata('emailBerhasil')){
                      echo "<div class='alert alert-success alert-dismissible'>";
                      echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
                      echo "<h4><i class='icon fa fa-ban'></i> Alert!</h4>";
                      echo $this->session->flashdata('emailBerhasil');
                      echo "</div>";
                    }else if($this->session->flashdata('emailGagal')){
                      echo "<div class='alert alert-danger alert-dismissible'>";
                      echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
                      echo "<h4><i class='icon fa fa-ban'></i> Alert!</h4>";
                      echo $this->session->flashdata('emailGagal');
                      echo "</div>";
                    }
                 ?>
               </div>
