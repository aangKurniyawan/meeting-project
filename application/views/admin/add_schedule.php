    ...
    <div class="col-md-6">
        <?php 
            if ($this->session->flashdata('duplicatSchedule2')){
              ...
              echo "</div>";
            }else if($this->session->flashdata('berhasilUpdateSchedule')){
              echo "<div class='alert alert-success alert-dismissible'>";
              echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
              echo "<h4><i class='icon fa fa-ban'></i> Alert!</h4>";
              echo $this->session->flashdata('berhasilUpdateSchedule');
              echo "</div>";
            }else if($this->session->flashdata('gagallUpdateSchedule')){
              echo "<div class='alert alert-danger alert-dismissible'>";
              echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
              echo "<h4><i class='icon fa fa-ban'></i> Alert!</h4>";
              echo $this->session->flashdata('gagallUpdateSchedule');
              echo "</div>";
            }
         ?>
       </div>
             ...
             <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo base_url('detail_schedule/');?><?php echo $data['id_schedule'];?>">
                    <button type="submit" class='btn btn-primary' style="padding:1px 6px;">Detail</button></a> 
                    <button type="submit" <?php $status=$data['status']; if($status !='Aktif'){ echo"class='btn btn-success hidden'"; }else{echo"class='btn btn-success'";}?> style="padding:1px 6px;" data-toggle="modal" data-target="#modal-edit<?php echo $data['id_schedule'];?>">Edit</button> 
                    <button type="submit" <?php $status=$data['status']; if($status !='Aktif'){ echo"class='btn btn-danger hidden'"; }else{echo"class='btn btn-danger'";}?> style="padding:1px 6px;"data-toggle="modal" data-target="#modal-delete<?php echo $data['id_schedule'];?>">Delete</button>
                  </td>
                </tr>
                <?php } ?>
                </tbody>
